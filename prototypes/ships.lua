...
-- Add an overlay in the upper right
...
indep_boat.collision_mask = {layers = {ground_tile=true, train=true, car=true, is_object=true}}
  ...
  smoke = {
    {
      ...
      deviation = {0.3, 0.3},
      frequency = 60,
      position = {0.5, 2.35},   -- Impossible to get the smoke in the right place on the boat in both vertical and horizontal orientations because the rolling stock connection distance changes
      starting_frame = 0,
      starting_frame_deviation = 60,
      height = 2.5,
      height_deviation = 0.2,
...
------------------------ CARGO SHIP ----------------------------
----------------------------------------------------------------
local cargo_ship_capacity = settings.startup["cargo_ship_capacity"].value
...
cargo_ship.inventory_size = cargo_ship_capacity * 1000
